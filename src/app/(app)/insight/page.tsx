    ...
    <div className="space-y-8 font-poppins">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Status Rata-rata */}
          <div className="bg-card border border-border rounded-3xl p-5 flex flex-col justify-between shadow-xs">
          ...
          <div className="bg-card border border-border rounded-3xl p-5 flex flex-col justify-between shadow-xs">
            ...
            <div className="flex items-center gap-4 mt-3">
              <div className="w-12 h-12 rounded-2xl bg-muted-light/50 flex items-center justify-center text-primary">
                <Clock className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-lg font-black text-primary">20 jam</h4>
                <p className="text-[10px] text-muted font-light mt-0.5">
                  Rata-rata 6j 40m per hari
                </p>
              </div>
            </div>
          </div>

          {/* Kebiasaan Paling Sering Muncul */}
          <div className="bg-card border border-border rounded-3xl p-5 flex flex-col justify-between shadow-xs">
            <span className="text-[10px] text-muted font-bold uppercase tracking-wider block">
              Kebiasaan Teraktif
            </span>
