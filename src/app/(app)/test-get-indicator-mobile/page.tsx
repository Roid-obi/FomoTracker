                  ...
                  {filteredApps.map((app) => {
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center justify-between p-3.5 hover:bg-muted-light/30 transition-all cursor-pointer select-none ${
                          isSelected ? "bg-muted-light/40" : ""
                        }`}
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-9 h-9 rounded-xl flex items-center justify-center text-xs font-bold text-white uppercase shadow-xs ${
                              app.isSystem ? "bg-secondary" : "bg-primary"
                            }`}
                          >
