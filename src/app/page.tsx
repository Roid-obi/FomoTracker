import { Activity, ArrowRight, BarChart2, Bell, BookOpen, Briefcase, Clock, Cpu, Download, Heart, Hourglass, Laptop, Moon, Shield, ShieldAlert, Smartphone, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background text-primary">
      ...
      <section id="problem" className="py-20 bg-card border-y border-border">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold font-poppins mb-4">Apakah ini Terasa Relatable Bagi Kamu?</h2>
            <p className="text-muted font-poppins font-light text-sm sm:text-base">Ketergantungan digital seringkali tidak disadari dan mempengaruhi kualitas kehidupan kita sehari-hari.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl border border-border bg-background/50 hover:border-primary/20 hover:shadow-md transition-all text-center flex flex-col items-center">
              ...
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">Membuka HP sebentar untuk cek sesuatu, tapi berakhir scroll tanpa tujuan selama berjam-jam.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-background/50 hover:border-primary/20 hover:shadow-md transition-all text-center flex flex-col items-center">
              ...
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">Kerjaan atau belajar terganggu setiap beberapa menit karena terdorong untuk mengecek notifikasi baru.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-background/50 hover:border-primary/20 hover:shadow-md transition-all text-center flex flex-col items-center">
              ...
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">Kebiasaan scrolling media sosial sebelum tidur membuat jam istirahat terganggu dan lelah di pagi hari.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted font-poppins font-light text-sm sm:text-base">Hanya dengan 3 langkah mudah untuk memulai perjalanan menuju kebiasaan digital yang lebih sehat.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Step 1 */}
            <div className="flex flex-col items-center text-center p-6 relative">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-lg mb-6 shadow-md shadow-primary/20">1</div>
              <h3 className="text-lg font-bold font-poppins mb-3">Pasang & Hubungkan</h3>
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">Install aplikasi mobile atau ekstensi browser FomoTracker, lalu hubungkan ke akunmu.</p>
            </div>

            {/* Step 2 */}
            <div className="flex flex-col items-center text-center p-6 relative">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-lg mb-6 shadow-md shadow-primary/20">2</div>
              <h3 className="text-lg font-bold font-poppins mb-3">Pantau Aktivitasmu</h3>
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">FomoTracker mendeteksi dan mencatat aktivitas media sosialmu secara otomatis.</p>
            </div>

            {/* Step 3 */}
            <div className="flex flex-col items-center text-center p-6 relative">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-lg mb-6 shadow-md shadow-primary/20">3</div>
              <h3 className="text-lg font-bold font-poppins mb-3">Dapatkan Insight</h3>
              <p className="text-muted text-sm leading-relaxed font-poppins font-light">AI kami menganalisis polamu dan memberikan rekomendasi personal untuk kebiasaan digital yang lebih baik.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 bg-card border-y border-border">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted font-poppins font-light text-sm sm:text-base">FomoTracker dilengkapi berbagai fitur cerdas untuk menunjang produktivitas dan digital wellbeing kamu.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl border border-border bg-background/60 hover:shadow-sm transition-all flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted text-sm leading-relaxed font-poppins font-light">Analisis mendalam pola kebiasaan digitalmu melalui dashboard interaktif terperinci.</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border bg-background/60 hover:shadow-sm transition-all flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted text-sm leading-relaxed font-poppins font-light">Rekomendasi yang disesuaikan secara dinamis berbasis data asli penggunaan HP kamu, bukan asumsi umum.</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border bg-background/60 hover:shadow-sm transition-all flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted text-sm leading-relaxed font-poppins font-light">Deteksi dini potensi penggunaan media sosial berlebihan menggunakan Bergen Social Media Addiction Scale.</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border bg-background/60 hover:shadow-sm transition-all flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted text-sm leading-relaxed font-poppins font-light">Pengingat cerdas yang muncul otomatis saat pola pemakaianmu mulai menyimpang dari target produktivitas.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-6 max-w-5xl relative">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-secondary bg-secondary/10 px-3 py-1 rounded-full font-poppins">Sangat Penting</span>
            <h2 className="text-2xl sm:text-3xl font-bold font-poppins mt-4 mb-4">Tersedia di 2 Platform</h2>
            <p className="text-muted font-poppins font-light text-sm sm:text-base">Pantau screen time-mu dari gadget manapun. Data tersinkronisasi secara otomatis dalam satu dashboard terpadu.</p>
          </div>
      ...
      <section className="py-20 bg-card border-t border-border">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted font-poppins font-light text-sm sm:text-base">FomoTracker dirancang untuk membawa dampak nyata bagi pembangunan berkelanjutan global.</p>
          </div>
          ...
          <div className="text-center p-4 rounded-xl border border-border/60 bg-muted-light max-w-md mx-auto">
            <p className="text-xs font-semibold text-primary font-poppins">💡 Catatan: FomoTracker adalah platform nirlaba untuk dampak sosial.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative overflow-hidden bg-primary text-white text-center">
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-10 flex flex-col items-center">
          <h2 className="text-2xl sm:text-4xl font-extrabold font-poppins tracking-tight mb-6">Mulai kenali kebiasaan digitalmu hari ini.</h2>
