...
import { AlertTriangle, AppWindow, BarChart, Bell, BookOpen, Brain, CheckSquare, ChevronDown, Clock, Eye, Gauge, Key, Laptop, ShieldAlert, Smartphone, UserPlus } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background text-primary">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 border-b border-border bg-card">
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center relative">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold font-poppins tracking-tight mb-4">Cara Menggunakan FomoTracker</h1>
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <aside className="md:col-span-1 hidden md:block">
            <div className="sticky top-24 space-y-2">
              ...
              <a href="#persiapan" className="block text-sm font-medium py-2 px-3 rounded-lg hover:bg-muted-light text-muted hover:text-primary transition-all font-poppins">
                1. Persiapan Awal
              </a>
              <a href="#onboarding" className="block text-sm font-medium py-2 px-3 rounded-lg hover:bg-muted-light text-muted hover:text-primary transition-all font-poppins">
                2. Setup Onboarding
              </a>
              <a href="#dashboard" className="block text-sm font-medium py-2 px-3 rounded-lg hover:bg-muted-light text-muted hover:text-primary transition-all font-poppins">
                3. Panduan Dashboard
              </a>
              <a href="#analytics" className="block text-sm font-medium py-2 px-3 rounded-lg hover:bg-muted-light text-muted hover:text-primary transition-all font-poppins">
                4. Memahami Analytics
              </a>
              <a href="#faq" className="block text-sm font-medium py-2 px-3 rounded-lg hover:bg-muted-light text-muted hover:text-primary transition-all font-poppins">
          ...
          <main className="md:col-span-3 space-y-16">
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-2xl border border-border bg-card flex gap-4">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-muted text-sm leading-relaxed font-poppins font-light mb-4">Pilih salah satu atau kedua platform di bawah ini sesuai perangkat Anda:</p>
            ...
            <section id="onboarding" className="scroll-mt-24 space-y-6">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                <div className="p-5 rounded-2xl border border-border bg-card">
                  ...
                  <p className="text-muted text-xs leading-relaxed font-poppins font-light">Tentukan aplikasi media sosial mana saja yang ingin dipantau (seperti Instagram, TikTok, Twitter, dsb).</p>
                </div>
                ...
                <div className="p-5 rounded-2xl border border-border bg-card">
                  ...
                  <p className="text-muted text-xs leading-relaxed font-poppins font-light">Sesuaikan jenis peringatan/pemberitahuan yang akan dikirim saat screen time terdeteksi berlebihan.</p>
                </div>
              </div>
            </section>
            ...
            <section id="analytics" className="scroll-mt-24 space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-2xl border border-border bg-card">
                  ...
                  <p className="text-muted text-xs leading-relaxed font-poppins font-light">Memahami pemicu pemakaian media sosial kamu seperti waktu-waktu tersering memegang HP (trigger hours).</p>
                </div>
            ...
            <section id="faq" className="scroll-mt-24 space-y-6">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div key={index} className="border border-border bg-card rounded-2xl overflow-hidden transition-all duration-200">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <ChevronDown className={`w-5 h-5 text-muted transition-transform duration-300 shrink-0 ${activeFaq === index ? "rotate-180" : ""}`} />
                    </button>
                    <div className={`overflow-hidden transition-all duration-300 ${activeFaq === index ? "max-h-40 border-t border-border/50 p-5 bg-background/30" : "max-h-0"}`}>
                      <p className="text-muted text-xs sm:text-sm leading-relaxed font-poppins font-light">{faq.answer}</p>
                    </div>
                  </div>
                ))}
              </div>
