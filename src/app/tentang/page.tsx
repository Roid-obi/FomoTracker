      ...
      <main className="container mx-auto px-6 max-w-4xl py-16 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="space-y-4 text-muted text-sm leading-relaxed font-poppins font-light">
              <p>
                <strong>FomoTracker</strong> adalah sebuah platform inovatif nirlaba yang didesain khusus untuk membantu
                masyarakat mengidentifikasi, memantau, dan mengendalikan kebiasaan digital mereka secara sadar.
              </p>
              <p>
                Lahir dari keprihatinan atas tingginya tingkat kecanduan media sosial dan fenomena FOMO (*Fear of Missing
                Out*), FomoTracker hadir untuk menjembatani kesenjangan antara teknologi digital dan kesejahteraan
          ...
          <div className="p-8 rounded-3xl border border-border bg-card shadow-sm flex flex-col justify-center items-center text-center">
            ...
            <p className="text-xs text-muted font-poppins font-light">
              "Sebuah ikhtiar sosial untuk melahirkan generasi yang bijak berteknologi dan produktif berkarya."
            </p>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div>
              ...
              <p className="text-muted text-xs sm:text-sm leading-relaxed font-poppins font-light">
                Kami percaya teknologi seharusnya menjadi alat bantu yang memberdayakan manusia, bukan rantai tak kasat
                mata yang mendikte fokus, waktu, dan kebahagiaan hidup kita sehari-hari.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted text-sm font-poppins font-light mb-6">
            FomoTracker tidak dibangun atas dasar asumsi belaka, melainkan dirancang berdasarkan studi akademis dan
            metodologi ilmiah digital wellbeing:
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl border border-border bg-card">
              ...
              <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                Mengintegrasikan indikator *Bergen Social Media Addiction Scale* (BSMAS) untuk menilai tingkat risiko
                ketergantungan secara klinis.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border bg-card">
              ...
              <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                Penerapan teori psikologi perilaku (*behavioral psychology*) untuk memetakan pemicu (*triggers*) refleks
            ...
            <div className="p-6 rounded-2xl border border-border bg-card">
              ...
              <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                Merujuk pada riset terbaru seputar kesejahteraan digital untuk menyusun rekomendasi personalisasi asisten
                AI.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-2xl border border-border bg-card flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                  Mendukung kesehatan mental masyarakat dengan menekan stres, cemas (*anxiety*), dan depresi yang dipicu
                  oleh adiksi dunia maya serta insomnia akibat layar HP.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl border border-border bg-card flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                  Membantu proses belajar generasi muda agar lebih efisien dan fokus dengan merancang batasan waktu sehat
                  agar terhindar dari siklus kecanduan gim/media sosial.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl border border-border bg-card flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted text-xs leading-relaxed font-poppins font-light">
                  Menjaga dan mendongkrak performa produktivitas para pekerja industri kreatif maupun formal dari
                  tuntutan notifikasi tanpa henti sepanjang jam produktif.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-6 text-center">
          ...
          <p className="text-muted text-sm font-poppins font-light max-w-xl mx-auto mb-8">
            FomoTracker dirancang oleh tim akademisi dan developer berdedikasi untuk kontribusi nyata dalam Lomba OLIVIA
            2026.
          </p>
          <div className="flex flex-col items-center justify-center">
            <div className="p-6 rounded-2xl border border-border bg-card max-w-sm w-full">
              ...
              <p className="text-muted text-xs font-poppins font-light leading-relaxed">
                Berkolaborasi menciptakan solusi digital wellbeing berbasis riset akademis dan inovasi teknologi terkini.
              </p>
            </div>
          </div>
        </section>
